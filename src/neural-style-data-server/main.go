...
var (
	...
	storageServerSaveRouter = flag.String("saveRouter", "/api/storage/save/v1", "URL router for save")
	storageServerFindRouter = flag.String("findRouter", "/api/storage/find/v1", "URL router for find")
