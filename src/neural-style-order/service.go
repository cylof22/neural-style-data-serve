...
func NewOrderSVC(logger log.Logger, session *mgo.Session, productsURL string) Service {
	return &OrderService{Logger: logger, Session: session, ProductsURL: productsURL}
}
